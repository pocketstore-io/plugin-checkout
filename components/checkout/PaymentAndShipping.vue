<template>
  ...
  >
    ...
    <div class="col-span-6 flex justify-between py-3">
      <button class="btn btn-secondary" @click="checkoutStep = 'addresses'">
        {{ $t("checkout.back.addresses") }}
      </button>
      <button class="btn btn-primary" @click="checkoutStep = 'confirm'">
        <span>{{ $t("checkout.continue.confirm") }}</span>
